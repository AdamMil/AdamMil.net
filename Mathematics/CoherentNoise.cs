...
/// slight wobbles, and many other things. Specifically, Perlin noise in 1, 2, and 3 dimensions, and Simplex noise in
/// 1, 2, 3, and 4 dimensions, are implemented.
/// </summary>
public sealed class CoherentNoise
{
  ...
  /// <summary>Initializes a new <see cref="CoherentNoise"/> object using the given seed.</summary>
  ...
  /// generator.
  /// </summary>
  public CoherentNoise(System.Random rand)
  {
    Reseed(rand);
  }
...
public void Print()
{
  ...
  public double Perlin(double x, double y)
  {
    ...
    double u = Fade(x); // calculate the fade curves for the X coordinate

    // return the blended results from the 4 vectors, scaled to be within [-1,1]. from a combination of empirical
    // analysis and mathematica tricks, the factor below has been determined to be the best IEEE double approximation
  ...
  public double Perlin(double x, double y, double z)
  {
    ...
    // return the blended results from the 8 vectors, scaled to be within [-1,1]. the factor below has been determined
  ...
  {
    Array.Copy(defaultPermutation, permutation, defaultPermutation.Length);
  }

  /// <summary>Randomizes the noise generated by this <see cref="CoherentNoise"/> class.</summary>
  public void Reseed()
  {
    Reseed(new System.Random());
  }

  /// <summary>Randomizes the noise generated by this <see cref="CoherentNoise"/> class based on the given seed.</summary>
  ...
  /// </summary>
  public void Reseed(System.Random rand)
  {
    for(int i=0; i<permutation.Length; i++) permutation[i] = (byte)i;
    Combinatorics.Permutations.RandomlyPermute(permutation, 0, 256, rand);
  }

  readonly byte[] permutation = new byte[256];
