...
public sealed class CoherentNoise
{
  ...
  /// <summary>Initializes a new <see cref="CoherentNoise"/> object, seeding it with values from the given random number generator.</summary>
  public CoherentNoise(RandomNumberGenerator random)
  {
    ...
    Combinatorics.Permutations.RandomlyPermute(permutation, random);
  }
  ...
  public double Perlin(double x, double y, double z)
  {
    ...
    // TODO: determine the actual correct scaling value
