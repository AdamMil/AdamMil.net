...
public static class Tasks
{
  ...
  /// <include file="documentation.xml" path="//Tasks/ParallelFor/node()"/>
  ...
  /// <include file="documentation.xml" path="//Tasks/ParallelForWithInit/node()"/>
  ...
  /// <include file="documentation.xml" path="//Tasks/ParallelForChunked/node()"/>
