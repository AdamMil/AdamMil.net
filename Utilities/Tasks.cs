...
/// <include file="documentation.xml" path="//Tasks/ParallelismRemarks/*"/>
public static class Tasks
{
  ...
  /// <include file="documentation.xml" path="//Tasks/ParallelFor/*"/>
  ...
  /// <summary>Executes a loop using the maximum number of hardware threads available.</summary>
  /// <include file="documentation.xml" path="//Tasks/ParallelFor/*[@name != 'body']"/>
  /// <include file="documentation.xml" path="//Tasks/ParallelForWithInit/*"/>
  ...
  /// <include file="documentation.xml" path="//Tasks/ParallelForChunked/*"/>
